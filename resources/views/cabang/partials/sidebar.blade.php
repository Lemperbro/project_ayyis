      ...
      <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          <ul class="pb-2 space-y-2">
            ...
            <li class="py-2">
              <a href="/cabang " class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
            ...
            <li class="py-2">
              ...
              <ul id="dropdown-layouts" class="hidden py-1 space-y-1">
                <li>
                  <a href="/cabang/ranting" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Admin Ranting</a>
                </li>
              </ul>
            </li>
            <li class="py-2">
              ...
              <ul id="dropdown-crud" class="space-y-2 py-2 hidden ">
                <li>
                  <a href="/cabang/confirmation" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Konfirmasi akun</a>
                </li>
              </ul>
            </li>
