                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li class="py-2">
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentcolor"
                                class="flex-shrink-0 w-6 h-6 text-gray-400 {{ request()->is('admin/cabang') || request()->is('admin/cabang/*') ? 'text-gray-900 dark:text-white' : '' }}" viewBox="0 0 640 512">
                    ...
                    <li class="py-2">
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="flex-shrink-0 w-6 h-6 text-gray-400 {{ request()->is('admin/ranting') || request()->is('admin/ranting/*') ? 'text-gray-900 dark:text-white' : '' }}" viewBox="0 0 640 512">
                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
                    ...
                    <li class="py-2">
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-6 h-6 text-gray-400 {{ request()->is('admin/konfirmasi') || request()->is('admin/konfirmasi/*') ? 'text-gray-900 dark:text-white' : '' }}"
