        ...
        <ul class="pb-2 space-y-2">
          ...
          <li class="py-2">
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li class="">
                     <a href="/admin/cabang" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Admin Cabang</a>
                  </li>
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Data Cabang</a>
                  </li>
            </ul>
         </li>
          <li class="py-2">
            ...
            <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Admin Ranting</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Data Ranting</a>
              </li>
            </ul>
          </li>
          <li class="py-2">
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 hidden ">
              <li>
                <a href="/admin/konfirmasi" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Konfirmasi akun</a>
              </li>
            </ul>
          </li>
