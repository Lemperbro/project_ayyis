        ...
        <div class="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3 pb-4 ">
            ...
            <div
                ...
                <div class="w-full">
                    ...
                    <div class="flex justify-between pt-4 pb-12">
                        <div>
                            <h1 class="font-bold text-6xl">{{ $jumlah_ranting->count() }}</h1>
                            <h1>Total Admin Ranting</h1>
                        </div>
            ...
            <div
                ...
                <div class="w-full">
                    ...
                    <div class="flex justify-between pt-4 pb-12">
                        <div>
                            <h1 class="font-bold text-6xl">{{ $jumlah_cabang->count() }}</h1>
                            <h1>Total Admin Cabang</h1>
                        </div>
