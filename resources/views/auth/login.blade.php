        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                @elseif (session('UpdateError'))
                    <div id="alert-2" class="flex items-center p-4 my-2 text-red-800 rounded-lg bg-red-300"
                        role="alert">
                        <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                ...
                @if (session('verified') == 'register')
                    <div id="alert-3"
                        class="flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-green-200 dark:text-green-600"
                        role="alert">
                        <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                ...
                <form class="space-y-4 md:space-y-6" action="/login" method="POST">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('lupaPassword') }}"
                            class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot
                            password?</a>
                    </div>
                    <button type="submit"
                        class="w-full text-white text-xl bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login</button>
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Belum Punya Akun? <a href="/register"
                            class="font-medium text-primary-600 hover:underline dark:text-primary-500">Daftar Dulu</a>
                    </p>
                </form>
            </div>
        </div>
